...
export const verifyNewOrderUserId = (req: Request, res: Response, next: NextFunction) => {
...
export const verifyNewOrderProductIds = (req: Request, res: Response, next: NextFunction) => {
